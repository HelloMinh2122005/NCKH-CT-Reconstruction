...
def parse_args():
    """
    Khai báo và xử lý tham số dòng lệnh phục vụ đánh giá (Testing & Benchmark) mô hình LEARN_LongNet.
    """
...
def main():
    ...
    print("=" * 80)
    print("📊 TIẾN HÀNH ĐÁNH GIÁ MÔ HÌNH: LEARN_LongNet_LA (Test & Benchmark)")
