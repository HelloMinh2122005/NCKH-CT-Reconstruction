...
def parse_args():
    """
    Khai báo tham số dòng lệnh phục vụ đánh giá (Testing) mô hình LEARN_Longformer.
    """
    parser = argparse.ArgumentParser(description="Đánh giá mô hình Baseline LEARN_Longformer trên Limited-Angle CT")
...
def main():
    ...
    print("=" * 70)
    print("📊 TIẾN HÀNH ĐÁNH GIÁ MÔ HÌNH: LEARN_Longformer_LA")
