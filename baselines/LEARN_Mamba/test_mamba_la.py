...
def parse_args():
    """
    Khai báo và xử lý tham số dòng lệnh phục vụ đánh giá (Testing & Benchmark) mô hình LEARN_Mamba.
    """
    ...
    parser.add_argument(
        ...
        help="Đường dẫn thư mục chứa ảnh DICOM (.IMA) gốc AAPM để lấy Ground Truth"
    )
    parser.add_argument(
...
def main():
    ...
    print("=" * 80)
    print("📊 TIẾN HÀNH ĐÁNH GIÁ MÔ HÌNH: LEARN_Mamba_LA (Test & Benchmark)")
    ...
    # Bước 7: Thực hiện đánh giá và xuất kết quả đo lường
