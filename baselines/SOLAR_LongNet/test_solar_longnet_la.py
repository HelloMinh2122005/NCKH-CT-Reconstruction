"""
================================================================================
SCRIPT ĐÁNH GIÁ: SOLAR_LongNet (LIMITED-ANGLE CT)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Đánh giá mô hình đề xuất SOLAR_LongNet trên Limited-Angle CT")
...
def main():
    ...
    print("=" * 80)
    print("📊 BẮT ĐẦU ĐÁNH GIÁ BENCHMARK: SOLAR_LongNet")
    ...
    model = SOLAR_LongNet_LA.load_from_checkpoint(
    ...
    print("\n" + "=" * 80)
    print("🏆 KẾT QUẢ BENCHMARK SOLAR_LongNet:")
    for res in results:
