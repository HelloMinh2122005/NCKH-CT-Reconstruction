"""
================================================================================
SCRIPT HUẤN LUYỆN: SOLAR_LongNet (LIMITED-ANGLE CT)
Second-Order Dual-Branch Unrolling with LongNet Dilated Attention
...
def parse_args():
    parser = argparse.ArgumentParser(description="Huấn luyện mô hình đề xuất SOLAR_LongNet trên Limited-Angle CT")
    ...
    # Checkpoint & Logging
    parser.add_argument("--output_dir", type=str, default="/datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_LongNet/")
    parser.add_argument("--log_dir", type=str, default="lightning_logs/SOLAR_LongNet/")
...
def main():
    ...
    print("=" * 80)
    print("🚀 BẮT ĐẦU HUẤN LUYỆN: SOLAR_LongNet (Limited-Angle CT)")
    ...
    logger = TensorBoardLogger(
        ...
        name="SOLAR_LongNet_LA",
    )
    
    checkpoint_callback = ModelCheckpoint(
        dirpath=args.output_dir,
        filename="solar_longnet_la-{epoch:02d}-{val_psnr:.2f}-{val_ssim:.4f}",
        save_top_k=3,
        monitor="val_psnr",
        mode="max",
        save_last=True,
    ...
    print("\n🎉 Huấn luyện SOLAR_LongNet hoàn thành thành công!")
