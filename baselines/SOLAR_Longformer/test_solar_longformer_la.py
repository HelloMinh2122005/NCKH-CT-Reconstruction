"""
================================================================================
SCRIPT ĐÁNH GIÁ: SOLAR_Longformer (LIMITED-ANGLE CT)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Đánh giá mô hình đề xuất SOLAR_Longformer trên Limited-Angle CT")
...
def main():
    ...
    print("=" * 80)
    print("📊 BẮT ĐẦU ĐÁNH GIÁ BENCHMARK: SOLAR_Longformer")
    ...
    model = SOLAR_Longformer_LA.load_from_checkpoint(
    ...
    print("\n" + "=" * 80)
    print("🏆 KẾT QUẢ BENCHMARK SOLAR_Longformer:")
    for res in results:
