"""
================================================================================
SCRIPT HUẤN LUYỆN: SOLAR_Longformer (LIMITED-ANGLE CT)
Second-Order Dual-Branch Unrolling with Longformer Attention
...
def parse_args():
    ...
    parser.add_argument("--num_global", type=int, default=50)
    ...
    # Checkpoint & Logging
    parser.add_argument("--output_dir", type=str, default="/datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_Longformer/")
    parser.add_argument("--log_dir", type=str, default="lightning_logs/SOLAR_Longformer/")
...
def main():
    ...
    print("=" * 80)
    print("🚀 BẮT ĐẦU HUẤN LUYỆN: SOLAR_Longformer (Limited-Angle CT)")
    ...
    logger = TensorBoardLogger(
        ...
        name="SOLAR_Longformer_LA",
    )
    
    checkpoint_callback = ModelCheckpoint(
        dirpath=args.output_dir,
        filename="solar_longformer_la-{epoch:02d}-{val_psnr:.2f}-{val_ssim:.4f}",
        save_top_k=3,
        monitor="val_psnr",
        mode="max",
        save_last=True,
    ...
    print("\n🎉 Huấn luyện SOLAR_Longformer hoàn thành thành công!")
