"""
================================================================================
SCRIPT ĐÁNH GIÁ: SOLAR_RegFormer (LIMITED-ANGLE CT)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Kiểm thử và đánh giá mô hình đề xuất SOTA SOLAR_RegFormer trên Limited-Angle CT")
...
def main():
    ...
    print("=" * 80)
    print("🔍 ĐÁNH GIÁ MÔ HÌNH ĐỀ XUẤT SOTA: SOLAR_RegFormer (Bậc 2 Newton-CG + Swin Attention)")
    ...
    model = SOLAR_RegFormer_LA.load_from_checkpoint(
        args.ckpt_path,
        num_view=args.num_view,
        num_detectors=args.num_detectors,
        start_ang=start_ang,
    ...
    print("\n📊 KẾT QUẢ ĐÁNH GIÁ ĐỊNH LƯỢNG (SOLAR_RegFormer):")
    print(results)
