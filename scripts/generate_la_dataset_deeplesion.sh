#!/bin/bash
#SBATCH --job-name=gen_la_deeplesion
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/generate_la_dataset_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/generate_la_dataset_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN DATA GENERATION =================
echo "[INFO] Launching Limited-Angle CT Data Preparation for NIH DeepLesion at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

python -u data/nih_deep_lesion/prepare_data_sinogram_LA_DeepLesion.py \
...
echo "[INFO] NIH DeepLesion Limited-Angle CT data preparation finished at $(date)"
