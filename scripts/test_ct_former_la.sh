#!/bin/bash
#SBATCH --job-name=test_ct_former_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_ct_former_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_ct_former_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CKPT_PATH="${1:-/datastore/uittogether3/LuuTru/MinhPD/saved_models/CT_Former/last.ckpt}"

echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 1: CT-Former trên Cấu hình Chuẩn LA-120° (64 views)"
echo "================================================================================"
python -u baselines/CT_Former/test_ct_former_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: CT-Former trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "================================================================================"
python -u baselines/CT_Former/test_ct_former_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "[INFO] CT-Former Testing finished at $(date)"
