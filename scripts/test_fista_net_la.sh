#!/bin/bash
#SBATCH --job-name=test_fista_net_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_fista_net_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_fista_net_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "================================================================================"
python -u baselines/FISTA_Net/test_fista_net_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: FISTA-Net trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "================================================================================"
python -u baselines/FISTA_Net/test_fista_net_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "[INFO] FISTA-Net Testing finished at $(date)"
