#!/bin/bash
#SBATCH --job-name=test_longnet_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_longnet_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_longnet_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TESTING =================
echo "[INFO] Launching LEARN_LongNet Testing on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

CKPT_PATH="/datastore/uittogether3/LuuTru/MinhPD/saved_models/LEARN_LongNet/last.ckpt"
if [ ! -f "$CKPT_PATH" ]; then
    CKPT_PATH="/datastore/uittogether3/LuuTru/MinhPD/saved_models/LEARN_LongNet/longnet_la-epoch=45-val_psnr=33.37-val_ssim=0.9090.ckpt"
fi

echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 1: LEARN_LongNet trên Cấu hình Chuẩn LA-120° (64 views)"
echo "================================================================================"
python -u baselines/LEARN_LongNet/test_longnet_la.py \
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: LEARN_LongNet trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "================================================================================"
python -u baselines/LEARN_LongNet/test_longnet_la.py \
    --checkpoint_path "$CKPT_PATH" \
    --cache_dir /datastore/uittogether3/LuuTru/MinhPD/dataset/limited_angle/ \
...
echo "[INFO] LEARN_LongNet Testing finished at $(date)"
