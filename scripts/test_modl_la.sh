#!/bin/bash
#SBATCH --job-name=test_modl_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_modl_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_modl_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
CKPT_PATH="${1:-/datastore/uittogether3/LuuTru/MinhPD/saved_models/MoDL/last.ckpt}"

echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 1: MoDL trên Cấu hình Chuẩn LA-120° (64 views)"
echo "================================================================================"
python -u baselines/MoDL/test_modl_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: MoDL trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "================================================================================"
python -u baselines/MoDL/test_modl_la.py \
    --ckpt_path "$CKPT_PATH" \
    --dataset_type aapm \
...
echo "[INFO] MoDL Testing finished at $(date)"
