#!/bin/bash
#SBATCH --job-name=test_solar_longformer_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_solar_longformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_solar_longformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT ĐÁNH GIÁ (TEST BENCHMARK) MÔ HÌNH ĐỀ XUẤT SOLAR_LONGFORMER
...
echo "[INFO] Launching SOLAR_Longformer Testing on Limited-Angle CT at $(date)"
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 1: SOLAR_Longformer trên Cấu hình Chuẩn LA-120° (64 views)"
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: SOLAR_Longformer trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "   (Đánh giá khả năng bù đắp góc khuyết mở rộng 270° của Sliding-Chunks Attention & Newton-CG)"
echo "================================================================================"
python -u baselines/SOLAR_Longformer/test_solar_longformer_la.py \
    --checkpoint_path "$CKPT_PATH" \
    --dataset_dir /datastore/uittogether3/LuuTru/MinhPD/dataset/limited_angle/ \
...
echo "[INFO] SOLAR_Longformer Testing finished at $(date)"
