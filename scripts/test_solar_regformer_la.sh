#!/bin/bash
#SBATCH --job-name=test_solar_regformer_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_solar_regformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/test_solar_regformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT ĐÁNH GIÁ (TEST BENCHMARK) MÔ HÌNH SOTA SOLAR_REGFORMER
...
echo "[INFO] Launching SOLAR_RegFormer Testing on Limited-Angle CT at $(date)"
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 1: SOLAR_RegFormer trên Cấu hình Chuẩn LA-120° (64 views)"
echo "   (Tập kiểm thử độc lập Patient L310: 214 lát cắt CT)"
echo "================================================================================"
python -u baselines/SOLAR_RegFormer/test_solar_regformer_la.py \
    --ckpt_path "$CKPT_PATH" \
...
echo "================================================================================"
echo "🎯 ĐÁNH GIÁ 2: SOLAR_RegFormer trên Cấu hình Khắc nghiệt LA-90° (64 views)"
echo "   (Đánh giá khả năng bù đắp góc khuyết mở rộng 270° của cơ chế Bậc 2 Newton-CG + Swin)"
echo "================================================================================"
python -u baselines/SOLAR_RegFormer/test_solar_regformer_la.py \
    --ckpt_path "$CKPT_PATH" \
    --cache_dir /datastore/uittogether3/LuuTru/MinhPD/dataset/aapm/limited_angle/ \
...
echo "[INFO] SOLAR_RegFormer Testing finished at $(date)"
