#!/bin/bash
#SBATCH --job-name=train_ct_former_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_ct_former_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_ct_former_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching CT-Former Training on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

python -u baselines/CT_Former/train_ct_former_la.py \
    --dataset_type aapm \
    ...
    --default_root_dir /datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_ct_former_la/ \
...
echo "[INFO] CT-Former Training finished at $(date)"
