#!/bin/bash
#SBATCH --job-name=train_dudonet_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_dudonet_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_dudonet_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching DuDoNet Training on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

python -u baselines/DuDoNet/train_dudonet_la.py \
    --dataset_type aapm \
    ...
    --saved_models_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/ \
    --default_root_dir /datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_dudonet_la/ \
...
echo "[INFO] DuDoNet Training finished at $(date)"
