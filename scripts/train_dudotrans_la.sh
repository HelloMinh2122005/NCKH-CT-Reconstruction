#!/bin/bash
#SBATCH --job-name=train_dudotrans_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_dudotrans_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_dudotrans_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching DuDoTrans Training on Limited-Angle CT at $(date)"
...
python -u baselines/DuDoTrans/train_dudotrans_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/DuDoTrans/ \
...
echo "[INFO] DuDoTrans Training finished at $(date)"
