#!/bin/bash
#SBATCH --job-name=train_fista_net_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_fista_net_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_fista_net_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching FISTA-Net Training on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

python -u baselines/FISTA_Net/train_fista_net_la.py \
    --dataset_type aapm \
    ...
    --default_root_dir /datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_fista_net_la/ \
...
echo "[INFO] FISTA-Net Training finished at $(date)"
