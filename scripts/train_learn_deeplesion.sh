#!/bin/bash
#SBATCH --job-name=tr_learn_deeplesion
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_learn_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_learn_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: LEARN (Original 3-Layer CNN) trên NIH DeepLesion CT
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN Training on NIH DeepLesion CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN/LEARN_DEEPLESION_LA_120deg_view64/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/LEARN/train_learn_la.py \
    --dataset_type deeplesion \
    --dataset_dir /datastore/uittogether3/LuuTru/MinhPD/dataset/nih_deep_lesion/limited_angle/ \
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN/ \
...
echo "[INFO] LEARN Training on NIH DeepLesion CT finished at $(date)"
