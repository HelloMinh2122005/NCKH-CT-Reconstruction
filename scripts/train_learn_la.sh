#!/bin/bash
#SBATCH --job-name=train_learn_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_learn_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_learn_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN (Original) Training on Limited-Angle CT at $(date)"
...
python -u baselines/LEARN/train_learn_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/LEARN/ \
...
echo "[INFO] LEARN Training finished at $(date)"
