#!/bin/bash
#SBATCH --job-name=tr_longfo_deeplesion
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: LEARN_Longformer trên NIH DeepLesion CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN_Longformer Training on NIH DeepLesion CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN_Longformer/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/LEARN_Longformer/train_longformer_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN_Longformer/ \
    ...
    --max_epochs 50 \
    --use_precomputed \
    --n_iterations 14 --lr 1e-4 \
    $EXTRA_ARGS

echo "[INFO] LEARN_Longformer Training on NIH DeepLesion CT finished at $(date)"
