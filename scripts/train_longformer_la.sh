#!/bin/bash
#SBATCH --job-name=train_longformer_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN_Longformer Training on Limited-Angle CT at $(date)"
