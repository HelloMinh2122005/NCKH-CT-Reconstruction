#!/bin/bash
#SBATCH --job-name=tr_longfo_lidc
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_lidc/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longformer_lidc/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: LEARN_Longformer trên LIDC-IDRI Lung CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN_Longformer Training on LIDC-IDRI Lung CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/LEARN_Longformer/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/LEARN_Longformer/train_longformer_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/LEARN_Longformer/ \
...
echo "[INFO] LEARN_Longformer Training on LIDC-IDRI Lung CT finished at $(date)"
