#!/bin/bash
#SBATCH --job-name=tr_longne_lidc
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longnet_lidc/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_longnet_lidc/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: LEARN_LongNet trên LIDC-IDRI Lung CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN_LongNet Training on LIDC-IDRI Lung CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/LEARN_LongNet/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/LEARN_LongNet/train_longnet_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/LEARN_LongNet/ \
    ...
    --max_epochs 50 \
    --use_precomputed \
    --n_iterations 14 --lr 1e-4 --window_size 16 \
    $EXTRA_ARGS

echo "[INFO] LEARN_LongNet Training on LIDC-IDRI Lung CT finished at $(date)"
