#!/bin/bash
#SBATCH --job-name=tr_mamba_deeplesion
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_mamba_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_mamba_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: LEARN_Mamba trên NIH DeepLesion CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching LEARN_Mamba Training on NIH DeepLesion CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN_Mamba/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/LEARN_Mamba/train_mamba_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/LEARN_Mamba/ \
...
echo "[INFO] LEARN_Mamba Training on NIH DeepLesion CT finished at $(date)"
