#!/bin/bash
#SBATCH --job-name=train_mamba_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_mamba_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_mamba_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "[INFO] LEARN_Mamba Training finished at $(date)"
