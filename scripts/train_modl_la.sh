#!/bin/bash
#SBATCH --job-name=train_modl_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_modl_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_modl_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python -u baselines/MoDL/train_modl_la.py \
    ...
    --default_root_dir /datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_modl_la/ \
...
echo "[INFO] MoDL Training finished at $(date)"
