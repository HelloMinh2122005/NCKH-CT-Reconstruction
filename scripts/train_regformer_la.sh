#!/bin/bash
#SBATCH --job-name=train_regformer_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_regformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_regformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching RegFormer Training on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

python -u baselines/RegFormer/train_regformer_la.py \
    --dataset_type aapm \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/RegFormer/ \
...
echo "[INFO] RegFormer Training finished at $(date)"
