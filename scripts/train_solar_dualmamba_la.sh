#!/bin/bash
#SBATCH --job-name=train_solar_dualmamba_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_dualmamba_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_dualmamba_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN MÔ HÌNH ĐỘT PHÁ MIỀN KÉP SOLAR_DualMamba TRÊN SLURM HPC
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_DualMamba Training on Limited-Angle CT (AAPM) at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_DualMamba/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_DualMamba/train_solar_dualmamba_la.py \
    --dataset_type aapm \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_DualMamba/ \
...
echo "[INFO] SOLAR_DualMamba Training finished at $(date)"
