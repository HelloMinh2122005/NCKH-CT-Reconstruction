#!/bin/bash
#SBATCH --job-name=train_solar_longformer
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_Longformer Training on Limited-Angle CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_Longformer/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_Longformer/train_solar_longformer_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_Longformer/ \
...
echo "[INFO] SOLAR_Longformer Training finished at $(date)"
