...
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longformer_lidc/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longformer_lidc/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: SOLAR_Longformer trên LIDC-IDRI Lung CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_Longformer Training on LIDC-IDRI Lung CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/SOLAR_Longformer/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_Longformer/train_solar_longformer_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/lidc_idri/SOLAR_Longformer/ \
...
echo "[INFO] SOLAR_Longformer Training on LIDC-IDRI Lung CT finished at $(date)"
