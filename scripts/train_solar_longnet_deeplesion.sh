...
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longnet_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_longnet_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: SOLAR_LongNet trên NIH DeepLesion CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_LongNet Training on NIH DeepLesion CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/SOLAR_LongNet/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_LongNet/train_solar_longnet_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/SOLAR_LongNet/ \
...
echo "[INFO] SOLAR_LongNet Training on NIH DeepLesion CT finished at $(date)"
