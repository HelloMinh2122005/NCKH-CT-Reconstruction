...
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_mamba_deeplesion/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_mamba_deeplesion/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT HUẤN LUYỆN: SOLAR_Mamba trên NIH DeepLesion CT (Limited-Angle CT)
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_Mamba Training on NIH DeepLesion CT at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/SOLAR_Mamba/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_Mamba/train_solar_mamba_la.py \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/deeplesion/SOLAR_Mamba/ \
...
echo "[INFO] SOLAR_Mamba Training on NIH DeepLesion CT finished at $(date)"
