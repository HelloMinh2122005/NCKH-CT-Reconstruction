#!/bin/bash
#SBATCH --job-name=train_solar_mamba
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_mamba_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_mamba_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_Mamba Training on Limited-Angle CT at $(date)"
