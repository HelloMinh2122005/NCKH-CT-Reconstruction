...
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_regformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/train_solar_regformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN TRAINING =================
echo "[INFO] Launching SOLAR_RegFormer Training on Limited-Angle CT (AAPM) at $(date)"

cd /datastore/uittogether3/LuuTru/MinhPD
export PYTHONPATH="/datastore/uittogether3/LuuTru/MinhPD:${PYTHONPATH:-}"

RESUME_CKPT="/datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_RegFormer/last.ckpt"
EXTRA_ARGS=""
...
python -u baselines/SOLAR_RegFormer/train_solar_regformer_la.py \
    --dataset_type aapm \
    ...
    --output_dir /datastore/uittogether3/LuuTru/MinhPD/saved_models/SOLAR_RegFormer/ \
...
echo "[INFO] SOLAR_RegFormer Training finished at $(date)"
