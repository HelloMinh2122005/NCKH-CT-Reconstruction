#!/bin/bash
#SBATCH --job-name=visualize_benchmark
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/visualize_benchmark/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/visualize_benchmark/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ================= RUN VISUALIZATION =================
echo "[INFO] Launching Benchmark Visualization Pipeline at $(date)"
...
echo "[INFO] Benchmark Visualization finished at $(date)"
