#!/bin/bash
#SBATCH --job-name=visualize_longformer_la
#SBATCH --output=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/visualize_longformer_la/log/%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/MinhPD/scripts/output/visualize_longformer_la/log/%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ==============================================================================
# SCRIPT TRỰC QUAN HÓA & KẾT XUẤT ẢNH CHO MÔ HÌNH LEARN_LONGFORMER
...
# ================= RUN VISUALIZATION =================
echo "[INFO] Launching LEARN_Longformer Visualization Pipeline at $(date)"
...
echo "   (Bao gồm ảnh tái tạo, Error Map và Panel đối sánh chứa LEARN_Longformer)"
echo "================================================================================"
python -u visualize_benchmark.py \
    --slices 50 100 150 \
...
echo "   (Đánh giá khả năng bù đắp nêm khuyết 270° của LEARN_Longformer)"
echo "================================================================================"
python -u visualize_benchmark.py \
    --slices 50 100 150 \
...
echo "[INFO] LEARN_Longformer Visualization finished at $(date)"
